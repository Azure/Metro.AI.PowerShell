...
# Import Private Functions (order matters for dependencies)
$privateFunctionOrder = @(
...
foreach ($functionName in $privateFunctionOrder) {
    $file = "$PSScriptRoot/Private/$functionName.ps1"
    if (Test-Path $file) {
        Write-Verbose "Loading private function: $functionName"
        . $file
    } else {
...
# Load any remaining private functions not in the ordered list
